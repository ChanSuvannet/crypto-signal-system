...
# backed/bots/market-data-bot/src/exchanges/kraken.py
# Deception: Kraken Exchange Connector: Handles data collection from Kraken exchange
# ============================================
...
class KrakenConnector:
    ...
    def __init__(self, config: Dict, logger):
        ...
        self.logger.info("KrakenConnector initialized")

    async def connect(self):
        """Connect to Kraken exchange"""
        try:
            self.logger.info("Connecting to Kraken...")
            ...
            self.exchange = ccxt.kraken(
                {
                    ...
                    "rateLimit": self.config.get("rate_limit", 1000),
            ...
            self.logger.error(f"Kraken connection failed: {e}", exc_info=True)
            raise
